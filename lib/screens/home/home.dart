...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var data = [
      ...
      Sales(
          "Require",
          userNotifier.userList[0].daily_kj_retuqire -
              userNotifier.userList[0].daily_kj_intake,
          Colors.grey[100]),
    ];
    ...
    var chart = charts.PieChart(
      series,
      defaultRenderer: charts.ArcRendererConfig(arcWidth: 7),
      animate: true,
    );
              ...
              children: <Widget>[
                Container(
                  ...
                  constraints: BoxConstraints.tightFor(
                      width: DeviceSizeFit.setPx(350.0),
                      height: DeviceSizeFit.setRpx(760)),
                  //size
                        ...
                        children: <Widget>[
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Text("Consumed (kJ)",
                                  style: TextStyle(
                                      fontSize: DeviceSizeFit.setPx(11),
                                      color: Colors.black)),
                            ],
                          ),
                          Column(
                            children: <Widget>[
                              Stack(
                                ...
                                children: <Widget>[
                                  SizedBox(
                                      height: DeviceSizeFit.setRpx(372),
                                      width: DeviceSizeFit.setPx(186),
                                      child: chart),
                                  Column(
                                    children: <Widget>[
                                      Text(userNotifier
                                              .userList[0].daily_kj_intake
                                              .toString() +
                                          '/' +
                                          userNotifier
                                              .userList[0].daily_kj_retuqire
                                              .toString()),
                                      Text("kj",
                                          style: TextStyle(
                                              fontSize: DeviceSizeFit.setPx(15),
                          ...
                          Column(
                            ...
                            children: <Widget>[
                              Text("2600",
                                  style: TextStyle(
                                      fontSize: DeviceSizeFit.setPx(14),
                                      color: Colors.black)),
                              Text("Burned(kj)",
                                  style: TextStyle(
                                      fontSize: DeviceSizeFit.setPx(10),
                                      color: Colors.black)),
                            ],
                          )
                        ],
                          ...
                          Column(
                            children: <Widget>[
                              Stack(
                                ...
                                children: <Widget>[
                                  SizedBox(
                                      height: DeviceSizeFit.setRpx(230),
                ...
                Container(
                  ...
                  constraints: BoxConstraints.tightFor(
                      width: DeviceSizeFit.setPx(350.0),
                      height: DeviceSizeFit.setRpx(500)), //size

                  decoration: BoxDecoration(
                      color: Colors.white, //box color
                      border: Border.all(
                          color: Colors.black12,
                          width: DeviceSizeFit.setPx(0.5)),
                      borderRadius: BorderRadius.circular(50),
                      boxShadow: [
                        //shadow
                        BoxShadow(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            constraints: BoxConstraints.tightFor(
                                width: DeviceSizeFit.setPx(330.0),
                                height: DeviceSizeFit.setRpx(90)), //size
                            decoration: BoxDecoration(
                                color: Colors.white, //box color
                                border: Border.all(
                                    color: Colors.black12,
                              ...
                              children: <Widget>[
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    "1221.95 kj",
                                    style: TextStyle(
                                        fontSize: DeviceSizeFit.setPx(13),
                                        color: Colors.blue),
                                  ),
                                ),
                              ],
